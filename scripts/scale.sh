...
# N
python main.py -g --ppd $PPD scale-exp $COMMON_ARGS --out-tag="N" -N 4000 -N 8000 -N 16000 -N 32000 -N 64000 -N 128000 -T 50 -d 2 -k 10
...
# SGD on N
python main.py -g --ppd $PPD scale-exp $COMMON_ARGS --out-tag="SGD-N" -N 50000 -N 100000 -N 1000000 -N 2000000 -T 50 -d 2 -k 10 --bs-y 50000
